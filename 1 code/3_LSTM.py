...
if __name__ == '__main__':
 ...
 # 30-70, 1-4
    ...
    if (TORCH_GPU == 0):
        ...
        lstm1 = myLSTM(Hidden_Size=60, Num_Layers=3).cuda(GPU_NUM)
    print(lstm1)
    ...
    loss_csv.to_csv('loss_save_3_LSTM_final.csv')

    # 保存完整模型
    torch.save(lstm1, '3_LSTM_final.pkl')
    ...
    pred.to_csv('pred_value_3_LSTM_final.csv')
