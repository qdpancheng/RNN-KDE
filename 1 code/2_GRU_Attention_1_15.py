...
if __name__ == '__main__':
    ...
    # 选择 5:00 -- 19:00 的光伏功率数据 (168) 使用5:00 5:05 5:10 5:15 的数据预测 5:30
    # 实际预测时间段 5:30 -- 19:00
    ...
    # 对训练集而言，batch=357, seq : 将 05:30 -- 19:00 的数据构造sequence, 根据偏相关图得到seq=4, feature=5 (第0列为功率值，第1-5列为气象特征)
    # 对验证集而言，batch=30,
    # 对测试集而言，batch=31,
    ...
    loss_csv.to_csv('loss_save_2_GRU_Attention_final_15min.csv')

    # 保存完整模型
    torch.save(gru, '2_GRU_Attention_final_15min.pkl')
    ...
    pred.to_csv('pred_value_2_GRU_Attention_final_15min.csv')
