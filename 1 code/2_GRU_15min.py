...
if __name__ == '__main__':
    ...
    # ---------------------- 以下为超参数确定过程 ----------------------------------------------
    # 采用 Grid Search 的方法进行超参数的确定 60-90,1-4
    HIDDEN_SIZE = [60 + 10 * ii for ii in range(1)]
    ...
    loss_csv.to_csv('loss_save_2_GRU_final_15min.csv')

    # 保存完整模型
    torch.save(gru, '2_GRU_final_15min.pkl')
    ...
    pred.to_csv('pred_value_2_GRU_final_15min.csv')
